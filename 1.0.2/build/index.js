/*
Wed Sep 24 2014 19:29:25 GMT+0800 (CST)
...
KISSY.add('kg/curve/1.0.1/index',["node","base","./lib/util"],function(S ,require, exports, module) {
...
var Curve = Base.extend({
    ...
    _prependItems : function(html){
        ...
        self._prependItemCatch(S.makeArray(items));

        var first = self.itemCatch.first;
        var len = items.length;

        var posInfo;
        S.each(items, function(item, index){
            posInfo = self.itemCatch[first + index].pos;
...
KISSY.add('kg/curve/1.0.1/lib/util',[],function(S ,require, exports, module) {
/**
